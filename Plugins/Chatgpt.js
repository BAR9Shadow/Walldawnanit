...
if (!text) throw `سابان اخيرا اصبح يدعم ميزة الذكاء الاصطناعي: يمكنك الان البحث عن البحوث والعروض والترجمة والاجابة عن التمارين والأسئلة كيف ما كان نوعها و بكل اللغات \n \n`
try {
...
handler.command = [ 'ذكاء-اصطناعي' ,  'chatgpt','ai','تكلم' ]
